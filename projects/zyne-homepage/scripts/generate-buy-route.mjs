...
.mobile-gallery-hero{position:relative;display:block;width:328px;height:198px;margin:10px 16px 0;border:1px solid rgba(231,195,74,.42);border-radius:10px;overflow:hidden;background:#10100e}.mobile-gallery-hero img{width:100%;height:100%;object-fit:cover;object-position:center 42%;transform:scale(1.06);display:block}.mobile-sale-badge{position:absolute;left:12px;top:12px;width:116px;height:64px;padding:0;color:#f7f3ea;background:rgba(5,5,5,.82);border:1px solid rgba(231,195,74,.55);border-radius:0;display:flex;flex-direction:column;align-items:center;justify-content:center}.mobile-sale-badge strong{display:block;color:#f2cc4d;font-size:17px;line-height:18px;font-weight:900;letter-spacing:.06em;white-space:nowrap}.mobile-sale-badge span{display:block;margin-top:4px;color:#f7f3ea;font-size:12px;font-weight:700;line-height:14px;letter-spacing:0;text-transform:none;white-space:nowrap}.mobile-photo-pill{position:absolute;right:12px;bottom:12px;height:38px;min-width:88px;padding:0 12px;border-radius:6px;background:rgba(5,5,5,.78);color:#f7f3ea;font-size:22px;font-weight:800;line-height:26px;display:flex;align-items:center;justify-content:center}
.mobile-copy{padding:0}.mobile-price{margin:16px 16px 0;color:#e7c34a;font-size:40px;font-weight:900;line-height:44px;letter-spacing:-.04em}.mobile-copy h1{margin:4px 16px 0;color:#f7f3ea;font-size:20px;line-height:24px;font-weight:800;letter-spacing:-.02em}.mobile-location{display:flex;align-items:center;gap:5px;margin:2px 16px 0;color:#f7f3ea;font-size:14px;font-weight:600;line-height:20px}.mobile-location svg{width:13px;height:13px;fill:#e7c34a;flex:none}.mobile-description{width:328px;max-height:46px;margin:10px 16px 0;color:#f7f3ea;font-size:16px;font-weight:500;line-height:23px;overflow:hidden}.mobile-financing-card{width:328px;height:78px;margin:14px 16px 0;padding:8px 16px;background:#0b0b0a;border:1px solid rgba(231,195,74,.3);border-radius:9px}.mobile-financing-card h2{margin:0;color:#f7f3ea;font-size:15px;line-height:18px;font-weight:800}.mobile-financing-card p{margin:2px 0 0;color:#f7f3ea;font-size:16px;line-height:18px;font-weight:800;white-space:nowrap}.mobile-financing-card .separator{color:#e7c34a;padding:0 5px}
...
@media(max-width:767px){body.buy-route header{min-height:64px;height:64px;padding-left:16px;padding-right:16px}body.buy-route header img{width:104px;height:36px;max-height:36px;object-fit:contain}body.buy-route .header-briefing{min-width:150px;width:150px;height:32px;padding:0;font-size:11px;line-height:12px;font-weight:800;white-space:nowrap}body.buy-route .mobile-menu-toggle{width:28px;height:20px;margin-left:10px;display:flex;flex-direction:column;justify-content:space-between}body.buy-route .mobile-menu-toggle span{width:28px;height:2px;margin:0;background:#f7f3ea;border-radius:2px}body.buy-route .mobile-menu-head img{width:132px;max-height:56px;object-fit:contain}}
  ...
  <main class="buy-page-stack mobile-buy-pages" aria-label="Mobile property listing">
    <section class="viewport-page mobile-page-one" aria-label="Mobile property overview">
      <div class="mobile-canvas">
        ...
        <section class="mobile-financing-card" aria-label="Investment terms"><h2>Seller financing available</h2><p>$30K down <span class="separator">•</span> 6.51% note</p><p>~$400/mo target cash flow</p></section>
