...
@media(max-width:767px){body.buy-route header{min-height:64px;height:64px;padding-left:8px;padding-right:12px;gap:8px}body.buy-route header img{width:150px;height:60px;max-height:60px;object-fit:contain}body.buy-route .header-briefing{min-width:0;width:54px;height:auto;margin-left:auto;padding:0;border:0;background:transparent;color:#f2cc4d;font-size:8px;line-height:9px;font-weight:300;letter-spacing:.02em;text-align:center;white-space:normal;opacity:1}body.buy-route .mobile-menu-toggle{width:28px;height:20px;margin-left:6px;display:flex;flex-direction:column;justify-content:space-between}body.buy-route .mobile-menu-toggle span{width:28px;height:2px;margin:0;background:#f7f3ea;border-radius:2px}}
