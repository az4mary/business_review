...
@media(max-width:767px){body.buy-route header{min-height:64px;height:64px;padding-left:16px;padding-right:16px}body.buy-route header img{width:126px;height:52px;max-height:52px;object-fit:contain}body.buy-route .header-briefing{min-width:150px;width:150px;height:32px;padding:0;font-size:11px;line-height:12px;font-weight:800;white-space:nowrap}body.buy-route .mobile-menu-toggle{width:28px;height:20px;margin-left:10px;display:flex;flex-direction:column;justify-content:space-between}body.buy-route .mobile-menu-toggle span{width:28px;height:2px;margin:0;background:#f7f3ea;border-radius:2px}}
