...
<head>
  ...
  <title>Investment Prospectus | ZYNE</title>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    :root {
      --bg: #070706; /* Inherited from 404.html */
      --panel: #0d0d0b;
      --gold: #c9a967; /* Inherited from 404.html */
      --gold2: #f1d37a;
      --text: #f1eadc;
      --muted: #b4aea3;
      --muted-dark: #746f67;
    ...
    body {
      ...
      overflow-x: hidden;
      overflow-y: hidden; /* Force lock to viewport for Page 1 */
    }
    ...
    .dashboard-wrapper {
      width: 100%;
      height: calc(100vh - 82px); /* Viewport minus exact header height */
      max-height: 859px; /* 941px target - 82px header */
      display: flex;
      align-items: center;
    ...
    .investment-dashboard {
      aspect-ratio: 1672 / 859; /* Adjusted for header offset */
      width: 100%;
      max-width: 1672px;
      max-height: 100%;
      padding: clamp(1rem, 2vw, 2.5rem);
      container-type: size; /* Enables ultra-fluid internal scaling */
    }
    ...
    /* Left Column Weights */
    .col-left .img-wrap:first-child { flex: 2; } /* Hero */
    .col-left .img-wrap:last-child { flex: 1; }  /* Bottom Wide */
    ...
    /* ==========================================================================
       SVG ICON ENGINE (1.25px Fine-Line)
       ========================================================================== */
    .zyne-icon {
...
<body>
  ...
  <!-- Scalable Viewport Dashboard Container -->
      ...
      <div class="dashboard-grid">
        ...
        <div class="photo-masonry">
          <div class="masonry-col col-left">
            <div class="img-wrap">
              <span class="status-badge">For Sale • Seller Financing</span>
              <!-- Placeholder: Replace with dynamic route image -->
              <div style="width:100%; height:100%; background:#1c2520;"></div> 
            </div>
            <div class="img-wrap">
              <div style="width:100%; height:100%; background:#153d5a;"></div>
            </div>
          </div>
          <div class="masonry-col col-right">
            <div class="img-wrap">
              <div style="width:100%; height:100%; background:#d4cfc7;"></div>
            </div>
            <div class="img-wrap">
              <div style="width:100%; height:100%; background:#bda316;"></div>
            </div>
            <div class="img-wrap">
              <div style="width:100%; height:100%; background:#8c1d1d;"></div>
            </div>
          </div>
        </div>
        ...
        <div class="data-sidebar">
          ...
          <div class="topbar">
            <div class="breadcrumbs">
              ...
              <span class="slash">/</span>
              <b style="color:var(--text);">7101 Wendemere St</b>
            </div>
            <div class="actions">
              <button>
          ...
          <div class="hero-data-split">
            <div class="core-info">
              ...
              <p class="location">Houston, TX 77088</p>
              <b class="price">$150,000</b>
              <p>Seller-financed Acres Homes investment opportunity with a 6.51% negotiated note, 20% down payment, oversized 7,250 sqft lot, zero HOA, and a value-add path toward $1,700/month target rent.</p>
            </div>
          ...
          <div class="agent-card-horizontal">
            <div class="agent-profile">
              <!-- Placeholder: Replace with actual agent path -->
              <img src="/assets/agents/carissa-weber.png" alt="Carissa Weber" onerror="this.src='data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxMDAlIiBoZWlnaHQ9IjEwMCUiPjxyZWN0IHdpZHRoPSIxMDAlIiBoZWlnaHQ9IjEwMCUiIGZpbGw9IiMzMzMiLz48L3N2Zz4='">
              <div class="agent-meta">
                <h4>Carissa Weber <span class="badge">PLATINUM</span></h4>
                <p>Better Homes and Gardens Real Estate<br>Gary Greene - Sugar Land</p>
              </div>
            </div>
