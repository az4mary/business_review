...
<meta name="theme-color" content="#070706"><title>${title} | ZYNE</title>
<style>
*{box-sizing:border-box}body{margin:0;background:#070706;color:#f1eadc;font-family:Inter,Segoe UI,Arial,sans-serif}a{color:inherit;text-decoration:none}
header{height:82px;padding:0 6vw;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #302815;position:sticky;top:0;background:#070706ee;z-index:4}header img{width:110px}
...
@media(max-width:1050px){.layout{grid-template-columns:1fr 1fr}.buybox{position:static;grid-column:1/-1}.visual{position:static}}@media(max-width:700px){header{height:68px}.layout{grid-template-columns:1fr}.visual{min-height:380px;padding:1rem}.visual img{height:360px}.details h1{font-size:2.8rem}.facts{grid-template-columns:1fr}.buybox{grid-column:auto}}
</style></head><body><header><a href="/"><img src="/assets/zyne-logo.png" alt="ZYNE"></a><a href="/#services">All services</a></header>
