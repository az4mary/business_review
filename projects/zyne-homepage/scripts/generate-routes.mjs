...
@media(max-width:1050px){.layout{grid-template-columns:1fr 1fr}.buybox{position:static;grid-column:1/-1}.visual{position:static}}@media(max-width:700px){header{height:68px;padding:0 1rem;position:relative}header img{width:76px}header>a:last-child{position:absolute;right:1rem;top:50%;transform:translateY(-50%);font-size:.7rem;white-space:nowrap}main{padding:1.5rem 1.25rem 4rem}.crumb{margin-bottom:1.5rem}.layout{grid-template-columns:minmax(0,1fr);gap:1.5rem}.visual{min-height:0;padding:1rem}.visual img{height:auto;max-height:390px}.details{min-width:0}.details h1{font-size:2.65rem;overflow-wrap:anywhere}.lead{font-size:.98rem;overflow-wrap:anywhere}.facts{grid-template-columns:1fr}.buybox{grid-column:auto}}
