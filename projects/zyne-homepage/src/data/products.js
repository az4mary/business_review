...
export const categories = [
  { id: categoryIds.visibility, number: "01", icon: "◎", title: "Grow My Visibility", description: "For businesses that need stronger local discovery, better profiles, clearer social presence, or more credible website visibility.", url: "/grow-my-visibility/", ctaLabel: "View Visibility Products", productIds: ["google-bp-mini-audit", "website-quick-win-audit", "social-media-quick-audit", "visibility-audit"] },
  { id: categoryIds.brand, number: "02", icon: "◇", title: "Build My Brand", description: "For businesses that need stronger visual identity, positioning, market authority, or sector-specific credibility.", url: "/build-my-brand/", ctaLabel: "View Brand Products", productIds: ["starter-brand-kit", "growth-brand-kit", "premium-brand-kit", "market-positioning", "sector-authority"] },
  { id: categoryIds.business, number: "03", icon: "⌁", title: "Improve My Business", description: "For founders, operators, and leadership teams that need strategic clarity, competitor insight, operational readiness, or an execution roadmap.", url: "/improve-my-business/", ctaLabel: "View Intelligence Products", productIds: ["executive-briefing", "growth-roadmap", "operational-audit", "competitor-readiness"] },
  { id: categoryIds.ai, number: "04", icon: "✦", title: "Use AI", description: "For businesses ready to identify, plan, or deploy AI systems, chatbot infrastructure, workflow automation, or real estate AI assistants.", url: "/use-ai/", ctaLabel: "View AI Products", productIds: ["realtor-gpt-starter-kit", "realtor-gpt-growth-kit", "ai-integration", "starter-ai-chatbot-kit"] },
  { id: categoryIds.conversion, number: "05", icon: "↗", title: "Convert More Clients", description: "For businesses that need stronger proof, referral assets, website architecture, origination systems, or lead-to-client pathways.", url: "/convert-more-clients/", ctaLabel: "View Conversion Products", productIds: ["experience-bank", "referral-kit", "origination-system", "web-architecture"] }
];
