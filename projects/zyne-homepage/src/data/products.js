...
export const catalogProducts = [
  product({ id: "google-bp-mini-audit", slug: "google-business-profile-mini-audit", name: "Google Business Profile Mini Audit", shortName: "Google BP Mini Audit", category: categoryIds.visibility, productType: "audit", price: "$49.99", description: "A focused profile check and expert fix roadmap for stronger local visibility.", bestFor: "New or under-optimized Google Business Profiles", timeline: "2 business days", revisions: "1 revision", image: "catalog/google-business-profile-mini-audit-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/google-business-profile-mini-audit", featured: true, homepageVisible: true, starterOffer: true }),
  product({ id: "website-quick-win-audit", slug: "website-quick-win-audit", name: "Website Quick-Win Audit", category: categoryIds.visibility, productType: "audit", price: "$49.99", description: "Find the clearest improvements to trust, messaging, and conversion.", bestFor: "Websites that feel stuck or unclear", timeline: "2 business days", image: "catalog/website-quick-win-audit-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/website-quickwin-audit", featured: true, homepageVisible: true, starterOffer: true }),
  product({ id: "social-media-quick-audit", slug: "social-media-quick-audit", name: "Social Media Quick Audit", category: categoryIds.visibility, productType: "audit", price: "$49.99", description: "A concise review of presence, consistency, and authority signals.", bestFor: "Businesses refining social credibility", timeline: "2 business days", image: "catalog/social-media-quick-audit-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/social-media-quick-audit", featured: true, homepageVisible: true, starterOffer: true }),
  product({ id: "homepage-fix-pack", slug: "homepage-fix-pack", name: "Homepage Fix Pack", category: categoryIds.conversion, productType: "website-service", price: "$149.99", description: "Priority homepage changes that sharpen clarity and conversion.", bestFor: "Service businesses with traffic but weak response", timeline: "3 business days", image: "catalog/homepage-fix-pack-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/homepage-fix-pack", featured: true, homepageVisible: true, starterOffer: true, deliveryOffer: true }),
  product({ id: "starter-brand-kit", slug: "starter-brand-kit", name: "Starter Brand Kit", category: categoryIds.brand, productType: "brand-kit", price: "$400", description: "A cohesive visual foundation for a more credible market presence.", bestFor: "New and evolving brands", timeline: "7–10 business days", image: "catalog/starter-brand-kit-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/starter-brand-kit-14zdq78a", featured: true, homepageVisible: true, starterOffer: true, deliveryOffer: true }),
  product({ id: "growth-brand-kit", slug: "growth-brand-kit", name: "Growth Brand Kit", category: categoryIds.brand, productType: "brand-kit", price: "$900", description: "A more complete brand identity system for growing businesses.", bestFor: "Brands ready for stronger identity consistency", timeline: "7–10 business days", image: "catalog/growth-brand-kit-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/growth-brand-kit", deliveryOffer: true }),
  product({ id: "premium-brand-kit", slug: "premium-brand-kit", name: "Premium Brand Kit", category: categoryIds.brand, productType: "brand-kit", price: "$1,500", description: "A premium visual identity package for authority and market trust.", bestFor: "Brands needing a stronger executive-grade presence", timeline: "10–15 business days", image: "catalog/premium-brand-kit-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/premium-brand-kit", deliveryOffer: true }),
  product({ id: "realtor-gpt-starter-kit", slug: "realtor-gpt-starter-kit", name: "Realtor GPT Starter Kit", shortName: "Realtor GPT Starter", category: categoryIds.ai, productType: "ai-kit", price: "$500", description: "A practical AI assistant foundation designed for real estate workflows.", bestFor: "Agents ready to work faster with AI", timeline: "3 business days", revisions: "1 optimization pass", image: "catalog/realtor-gpt-starter-kit-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/realtor-gpt-starter-kit", featured: true, homepageVisible: true, starterOffer: true, deliveryOffer: true }),
  product({ id: "realtor-gpt-growth-kit", slug: "realtor-gpt-growth-kit", name: "Realtor GPT Growth Kit", shortName: "Realtor GPT Growth", category: categoryIds.ai, productType: "ai-kit", price: "$900", description: "An expanded real estate AI assistant system for repeatable client workflows.", bestFor: "Agents or teams building repeatable AI-supported workflows", timeline: "5 business days", image: "catalog/realtor-gpt-growth-kit-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/realtor-gpt-growth-kit", deliveryOffer: true }),
  product({ id: "executive-briefing", slug: "executive-briefing", name: "Executive Briefing", category: categoryIds.business, productType: "briefing", price: "$750", description: "A concentrated strategic briefing to clarify constraints and next moves.", bestFor: "Leaders making a consequential decision", timeline: "3–5 business days", revisions: "1 revision round", image: "catalog/executive-briefing-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/executive-briefing", featured: true, homepageVisible: true, starterOffer: true, premiumOffer: true, intelligenceOffer: true, intelligenceDescription: "Clarify the central constraint and the highest-leverage next move." }),
  product({ id: "visibility-audit", slug: "visibility-audit", name: "Visibility Audit", category: categoryIds.visibility, productType: "audit", price: "$950", description: "A full diagnostic of discovery, trust signals, and public presence.", bestFor: "Businesses that need a visibility plan", timeline: "5–7 business days", revisions: "1 revision round", image: "catalog/visibility-audit-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/visibility-audit", featured: true, homepageVisible: true, starterOffer: true, premiumOffer: true, intelligenceOffer: true, intelligenceDescription: "Diagnose discovery, credibility, and public-presence gaps." }),
  product({ id: "growth-roadmap", slug: "growth-roadmap", name: "Growth Roadmap", category: categoryIds.business, productType: "roadmap", price: "$1,500", description: "Turn competing priorities into a sequenced growth plan.", bestFor: "Businesses that need a clear next-build sequence", timeline: "5–7 business days", image: "catalog/growth-roadmap-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/growth-roadmap", intelligenceOffer: true, intelligenceDescription: "Turn competing priorities into a sequenced growth plan." }),
  product({ id: "market-positioning", slug: "market-positioning", name: "Market Positioning", category: categoryIds.brand, productType: "strategy", price: "$1,750", description: "Define a sharper market angle, message, and authority position.", bestFor: "Businesses that need a sharper market angle and stronger authority", timeline: "7–10 business days", image: "catalog/market-positioning-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/market-positioning", premiumOffer: true, intelligenceOffer: true, intelligenceDescription: "Define a sharper market angle, message, and authority position." }),
  product({ id: "ai-integration", slug: "ai-integration", name: "AI Integration", category: categoryIds.ai, productType: "ai-strategy", price: "$1,750", description: "Identify practical AI opportunities and an implementation path.", bestFor: "Teams that need a practical, commercially useful AI plan", timeline: "7–10 business days", image: "catalog/ai-integration-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/ai-integration", premiumOffer: true, intelligenceOffer: true, intelligenceDescription: "Identify practical AI opportunities and an implementation path." }),
  product({ id: "starter-ai-chatbot-kit", slug: "starter-ai-chatbot-kit", name: "Starter AI Chatbot Kit", shortName: "AI Chatbot Kit", category: categoryIds.ai, productType: "ai-chatbot", price: "$4,200", description: "A starter chatbot system for structured client-facing automation.", bestFor: "Businesses ready to deploy conversational AI infrastructure", timeline: "10–15 business days", image: "catalog/starter-ai-chatbot-kit-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/starter-ai-chatbot-kit", deliveryOffer: true }),
  product({ id: "experience-bank", slug: "experience-bank", name: "Experience Bank", category: categoryIds.conversion, productType: "proof-system", price: "$1,250", description: "Build a structured proof asset from client experience, credibility, and results.", bestFor: "Businesses that need stronger trust and proof assets", timeline: "5–7 business days", image: "catalog/experience-bank-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/experience-bank", deliveryOffer: true }),
  product({ id: "referral-kit", slug: "referral-kit", name: "Referral Kit", category: categoryIds.conversion, productType: "conversion-kit", price: "$1,250", description: "Create referral assets and scripts that make client introductions easier.", bestFor: "Businesses that want a cleaner referral pathway", timeline: "5–7 business days", image: "catalog/referral-kit-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/referral-kit", deliveryOffer: true }),
  product({ id: "origination-system", slug: "origination-system", name: "Origination System", category: categoryIds.conversion, productType: "conversion-system", price: "$1,950", description: "A repeatable path from attention to opportunity.", bestFor: "Experts who need a repeatable path from attention to opportunity", timeline: "7–10 business days", image: "catalog/origination-system-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/origination-system", premiumOffer: true, deliveryOffer: true }),
  product({ id: "sector-authority", slug: "sector-authority", name: "Sector Authority", category: categoryIds.brand, productType: "authority-strategy", price: "$1,950", description: "A focused authority package for sector credibility and positioning.", bestFor: "Businesses that need stronger sector-specific credibility", timeline: "7–10 business days", image: "catalog/sector-authority-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/sector-authority", intelligenceOffer: true }),
  product({ id: "web-architecture", slug: "web-architecture", name: "Web Architecture", category: categoryIds.conversion, productType: "website-strategy", price: "$2,500", description: "Plan the structure, page logic, and conversion architecture for a stronger website.", bestFor: "Businesses rebuilding their digital conversion infrastructure", timeline: "7–10 business days", image: "catalog/web-architecture-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/web-architecture", premiumOffer: true, deliveryOffer: true }),
  product({ id: "operational-audit", slug: "operational-audit", name: "Operational Audit", category: categoryIds.business, productType: "audit", price: "$2,500", description: "Examine readiness, friction, and operational improvement priorities.", bestFor: "Leadership teams addressing friction, readiness, and scale", timeline: "10–15 business days", image: "catalog/operational-audit-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/operational-audit", premiumOffer: true, intelligenceOffer: true, intelligenceDescription: "Examine readiness, friction, and operational improvement priorities." }),
  product({ id: "competitor-readiness", slug: "competitor-readiness", name: "Competitor Readiness", category: categoryIds.business, productType: "competitive-intelligence", price: "$2,950", description: "Build a strategic response to the competitive landscape.", bestFor: "Businesses preparing to defend or expand their market position", timeline: "7–10 business days", image: "catalog/competitor-readiness-thumbnail.png", stanCheckoutUrl: "https://stan.store/ZYNE_store/p/competitor-readiness", premiumOffer: true, intelligenceOffer: true, intelligenceDescription: "Build a strategic response to the competitive landscape." })
];
