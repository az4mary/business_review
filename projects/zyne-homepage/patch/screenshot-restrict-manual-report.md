...
- GitHub emitted a Node.js 20 deprecation warning for `actions/checkout@v4`, `actions/setup-node@v4`, and `actions/upload-artifact@v4`, which the runner forced onto Node.js 24.
