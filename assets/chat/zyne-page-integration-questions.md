...
Once the developer returns this audit, I will write the exact instructions on what to gut and how to write the global CI/CD blocker script.

Would you like me to draft the baseline criteria for that global validator script now so you have it ready to deploy alongside the teardown instructions?
